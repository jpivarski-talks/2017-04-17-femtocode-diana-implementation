...
%% \vspace{0.3 cm}
%% We know whether a number in the size array refers to the outer or inner collection type by counting down, from left to right.
%% \end{frame}

%% \begin{frame}[fragile]{Structure of an event loop}
%% \begin{center}
